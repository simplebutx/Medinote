...
from app.api.routes.medicine_caution_tag import router as medicine_caution_tag_router
from app.api.routes.ocr import router as ocr_router
from app.api.routes.prescription_analysis import router as prescription_analysis_router
...
api_router.include_router(medicine_caution_tag_router, tags=["medicine-caution-tags"])
api_router.include_router(ocr_router, tags=["ocr"])
api_router.include_router(prescription_analysis_router, tags=["prescription-analysis"])
